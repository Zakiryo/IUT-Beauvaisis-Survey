...
<body style="width: 1500px">
    ...
    <div id="form-survey" class="content">
        <form  action="" method="post">
            ...
            <div class="div-flex" class="row mt-2" id="div-noms">
            ...
            <br>
            <div class="div-flex" id="div-vil" class="row mt-2">
